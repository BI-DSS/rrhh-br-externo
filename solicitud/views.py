	...
	if request.POST:
		with transaction.atomic():
			try:
				...
				ingreso.totalamortizacion = None if request.POST.get('totalamortizacion') == '' else request.POST.get('totalamortizacion').replace(',','')
				ingreso.totalinquilino = None if request.POST.get('totalinquilino') == '' else request.POST.get('totalinquilino').replace(',','')
				ingreso.totalpensionista = None if request.POST.get('totalpensionista') == '' else request.POST.get('totalpensionista').replace(',','')
				...
				ingreso.montodeuda = None if request.POST.get('montodeuda') == '' else request.POST.get('montodeuda').replace(',','')
				ingreso.cuotamensual = None if request.POST.get('cuotamensual') == '' else request.POST.get('cuotamensual').replace(',','')
				...
				ingreso.montoembargo = None if request.POST.get('montoembargo') == '' else request.POST.get('montoembargo').replace(',','')
				...
				ingreso.sueldopretende = None if request.POST.get('sueldopretende') == '' else request.POST.get('sueldopretende').replace(',','')
		...
		with transaction.atomic(): 
			try:
				...
				for x in nombreempresa:
					...
					laboral.salariofinal = None if salariofinal[counter] == '' else salariofinal[counter].replace(',','')
