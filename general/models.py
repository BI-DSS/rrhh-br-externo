...
#Las credenciales del envio de correo estan encriptadas
class Credenciales(models.Model):
    usuario = models.CharField(max_length=500, blank=True, null=True, db_column='Usuario')
    clave = models.CharField(max_length=500, blank=True, null=True, db_column='Clave')
    class Meta:
        managed = False
